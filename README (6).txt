...
1) Download the entire 'ElsevierInternetOfThings-31-101584' directory to a machine.

Call the following docker commands inside the 'ElsevierInternetOfThings-31-101584' directory:
