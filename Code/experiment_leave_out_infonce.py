...
pre_train_history = pre_train_model.fit(x=pre_train_set, epochs=args.epoch_size, steps_per_epoch=(len(train_instance_indices) * step_multiplier) // args.batch_size,
...
fine_train_history = fine_tune_model.fit(x=fine_train_set, epochs=args.epoch_size, steps_per_epoch=(len(fine_train_instance_indices) * step_multiplier) // (args.batch_size // 2),
